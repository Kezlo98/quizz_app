...
public class UserController {
  ...
  public String updatePassword(@ModelAttribute PasswordUpdateRequest passwordUpdateRequest,
      RedirectAttributes redirectAttributes, Authentication authentication) {
    String error = validatePasswordUpdateRequest(passwordUpdateRequest);
    if (!StringUtils.hasLength(error)) {
      String notification = userService.changePassword(passwordUpdateRequest,
  ...
  private String validatePasswordUpdateRequest(PasswordUpdateRequest passwordUpdateRequest) {
    ...
    if (!StringUtils.hasLength(currentPassword) || !StringUtils.hasLength(newPassword)
        || !StringUtils.hasLength(confirmNewPassword)) {
