...
(function ($) {
  ...
  $.extend($.fn, {
    ...
    validate: function (options) {
      ...
      if (!this.length) {
        options && options.debug && window.console && console.warn(
  ...
  $.extend($.validator, {
    ...
    prototype: {
      ...
      init: function () {
        ...
        function delegate(event) {
          ...
          validator.settings[eventType] && validator.settings[eventType].call(
    ...
    methods: {
      ...
      dateISO: function (value, element) {
        return this.optional(element) || /^\d{4}[\/-]\d{1,2}[\/-]\d{1,2}$/.test(
            value);
      },
